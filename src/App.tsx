...
function App() {
  ...
  return (
    <section className="tablet:px-5 px-3">
      <section className="max-w-[800px] mx-auto mt-15">
        ...
        <div className="flex py-10 gap-3 justify-around max-w-[500px] mx-auto">
          ...
          <input
            ...
            className="border-2 border-[#3d3d3d] max-w-[50%] px-4 py-2 rounded-[10px] outline-none"
            type="text"
          />
          <button
        ...
        <section className="rounded-[15px] bg-[#f4f4f4] w-full med:px-5 px-3 tablet:px-10 pt-6 pb-7 mb-10">
          <section className="flex justify-between gap-3 items-center mb-5">
            ...
            <input
              ...
              className=" bg-[#eaeaea] px-3 max-w-[50%] py-1.5 rounded-[10px] outline-none"
              type="text"
              placeholder="найти..."
            />
          </section>
        ...
        {checkedTodos.length != 0 ? (
          <section className="rounded-[15px] bg-[#f4f4f4] w-full med:px-5 px-3 tablet:px-10 pt-6 pb-7 ">
